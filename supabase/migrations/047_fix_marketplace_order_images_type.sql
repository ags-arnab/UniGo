-- Migration: Fix marketplace_order function to correctly handle text[] images

-- Update the create_marketplace_order function to handle images as text[] instead of jsonb
