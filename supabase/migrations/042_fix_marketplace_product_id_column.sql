...
BEGIN
    ...
    FOREACH v_input_item IN ARRAY p_items LOOP
        ...
        -- Use the new column names marketplace_order_id and marketplace_product_id
        INSERT INTO public.marketplace_order_items (marketplace_order_id, marketplace_product_id, quantity, price_at_purchase, selected_attributes)
